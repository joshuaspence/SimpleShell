 ...
 * SID:    308216350
 *
 * This file defines strings used in the 'myshell' shell. The shell can be
 * customised by changing strings in this file.
*/
#ifndef __STRINGS_H_
#define __STRINGS_H_
...
#define README_PATH                 "./manual" // path to readme file relative to startup path
